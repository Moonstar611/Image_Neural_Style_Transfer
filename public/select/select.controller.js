  ...
  return CoreObject.extend({
    ...
    init: ['$state', function ($state) {
      ...
      this.selections = [
        ...
        {
          name: 'Impression, Sunrise - Claude Monet',
          id: 1,
          url: this.PIC_URL_TEMPLATE + 'sun_rise.jpg'
        },
        {
          name: 'Liberty Leading The People - Eugene Delacroix',
          id: 2,
          url: this.PIC_URL_TEMPLATE + 'liberty_leading_the_people.jpg'
        },
        {
          name: 'Girl Before A Mirror - Pablo Picasso',
          id: 3,
          url: this.PIC_URL_TEMPLATE + 'girl_before_a_mirror.jpg'
        }
      ];
